%w8e.m linear regression using fitlm (outlier excluded 
% and robust regression)
clear all; close all, clc

%modify one data to intorduce outlier  
x=[200, 1000,1550, 900, 1300, 400, 500, 720]';
y=[370, 840, 1080, 250, 910, 395, 495, 680]';
...
[~, y_outs] = max(abs(yO_lm.Residuals.Raw))
...
%weight applied to data set
yRE_weights=yRE_lm.Robust.Weights
